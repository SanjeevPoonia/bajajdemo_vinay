...
class QualityService extends StatefulWidget {
  QualityState createState() => QualityState();
}

class QualityState extends State<QualityService> {
      ...
      body: ListView(
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.arrow_back_ios, color: Color(0xFf929292)),
                SizedBox(width: 12),
                Expanded(
                  child: Center(
                    child: Text('Quality of Service',
                        style: TextStyle(
                            fontSize: 16,
